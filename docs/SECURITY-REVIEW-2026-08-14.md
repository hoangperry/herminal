...
- All four former hardened-runtime exceptions passed one-at-a-time signed debug and release experiments and were removed from production. The evidence is recorded in `docs/QA/results/entitlement-audit-2026-08-15.md`; CI prevents restoring the retired permissions.
